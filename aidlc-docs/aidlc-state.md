...
- [ ] Post-Unit 10 follow-ups (started 2026-09-04): owner approved A (deploy checklist), B (theme-toggle titles), C (current belt), D (security headers and rate limiting); E nothing, the other follow-ups stay deferred. Requirements: inception/requirements/requirements-post-unit10-followups.md (B minimal, C standard, D standard). Owner checklist for A: construction/unit10-bjj-landing/owner-deploy-checklist.md (delivered 2026-09-04; the owner completed it the same day: SITE_FLAVOR=bjj live in production).
  ...
  - [ ] Unit 13: admin résumé upload (feat, S, no migration): owner request 2026-09-11, grilled in two rounds (sixteen decisions, design tree settled); requirements inception/requirements/requirements-admin-resume-upload.md approved 2026-09-11 (A); workflow plan inception/plans/workflow-planning-units-13-14.md approved 2026-09-11; code-generation plan construction/plans/unit13-admin-resume-upload-plan.md approved 2026-09-11 (A), Part 2 in progress; sequenced ahead of Units 11 and 12 (owner, decision 10); production compose résumé mount made read-write 2026-09-11; CONTEXT.md Résumé term written
