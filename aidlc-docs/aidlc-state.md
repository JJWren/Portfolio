...
- [ ] Post-Unit 10 follow-ups (started 2026-09-04): owner approved A (deploy checklist), B (theme-toggle titles), C (current belt), D (security headers and rate limiting); E nothing, the other follow-ups stay deferred. Requirements: inception/requirements/requirements-post-unit10-followups.md (B minimal, C standard, D standard). Owner checklist for A: construction/unit10-bjj-landing/owner-deploy-checklist.md (delivered 2026-09-04; the owner completed it the same day: SITE_FLAVOR=bjj live in production).
  ...
  - [x] Quick change (owner insertion 2026-09-04): pinned site header as PR 0 — requirements section 4.4; plan construction/plans/quick-pinned-header-plan.md; approved 2026-09-05 (A), implemented (orchestrator, five-area review applied), merged by the owner 2026-09-05 as PR #99 (fc793aa), released in v1.26.0 (PR #100) and deployed by the owner 2026-09-05 (production runs 1.26.0)
  - [x] Unit 10 addendum (Phase 6): BJJ wording for the theme-toggle tooltip (feat, XS) — plan construction/plans/unit10-addendum-tooltip-plan.md approved 2026-09-05 (wording corrected to black gi); implemented (orchestrator, five-area review applied, 705 tests); merged 2026-09-05 as PR #101 (9d97fd1) after a Copilot pass with zero comments; release and deploy pending
  - [x] Unit 13: admin résumé upload (feat, S, no migration): owner request 2026-09-11, grilled in two rounds (sixteen decisions, design tree settled); requirements inception/requirements/requirements-admin-resume-upload.md approved 2026-09-11 (A); workflow plan inception/plans/workflow-planning-units-13-14.md approved 2026-09-11; code-generation plan construction/plans/unit13-admin-resume-upload-plan.md approved 2026-09-11 (A); COMPLETE 2026-09-11: implemented by a Sonnet phase agent with the five-area review applied, merged as PR #103 (b45f1f0) after two Copilot rounds, 748 tests and 43 fixtures; release and deploy follow Unit 14 (owner instruction): DEPLOYED 2026-09-12 in v1.28.0 (the read-write résumé mount active; the admin upload check stays the owner's); sequenced ahead of Units 11 and 12 (owner, decision 10); production compose résumé mount made read-write 2026-09-11; CONTEXT.md Résumé term written
  - [x] Unit 14: daily-visitors chart on /admin/stats (feat, S, no migration): owner request 2026-09-11 during the Unit 13 gate; grilled (round 3, eight decisions: queue position owner-answered, the other seven taken as recommended); requirements inception/requirements/requirements-admin-stats-visitors-chart.md approved 2026-09-11 (A, assumptions included); workflow plan inception/plans/workflow-planning-units-13-14.md approved 2026-09-11; code-generation plan construction/plans/unit14-visitors-chart-plan.md written 2026-09-11 and pre-approved by the owner instruction; COMPLETE 2026-09-12: implemented by a Sonnet phase agent with the five-area review applied by a remediation agent, merged as PR #106 (3a8cf52) after four Copilot rounds, 825 tests and 46 fixtures; release 1.28.0 and the deploy follow: DEPLOYED 2026-09-12 (v1.28.0 live, container healthy, live links and the download endpoint checked; the admin stats page check stays the owner's); sequenced after Unit 13 and before Units 11 and 12 (owner); CONTEXT.md Period term written
  - Handoff for the next session (2026-09-13): aidlc-docs/handoff.md (read first; Units 11 and 12 are next)
  - [x] Grilling session (2026-09-13): the handoff, the requirements and the workflow plan reviewed; fourteen decisions, all as recommended ("good answers"); amendments in requirements section 10 and the workflow plan's grilling outcome; CONTEXT.md terms Current Belt (new), Rank Bar and Degree (generalized); gates collapse to one approval per unit (Q1 C); release and deploy after 12a and after 12b (Q2 B)
  - [x] Quick fix (owner decision 2026-09-13, Q3): average per day on the Daily visitors tile (fix, XS, PR 1.5 ahead of Unit 11) — requirements FR-S1 to FR-S3; plan construction/plans/quick-stats-tile-plan.md; approved 2026-09-13 in the Unit 11 stop (B); COMPLETE 2026-09-13: orchestrator-implemented, five-area review applied, merged as PR #107 (e79bf49) after a clean Copilot pass; 837 tests, 46 fixtures; release rides with Unit 11 and 12a
  - [x] Unit 11: current belt for the rank bar (feat, S, migration AddCurrentBelt) — functional design construction/unit11-current-belt/functional-design/ (BR-20 to BR-25) and plan construction/plans/unit11-current-belt-plan.md approved 2026-09-13 (B, one stop with the quick-fix plan); COMPLETE 2026-09-14: implemented by a Sonnet phase agent from construction/plans/unit11-brief.md (seven commits), five-area review (correctness, security and performance PASS; maintainability and framework findings applied by a remediation agent), merged as PR #109 (069ef12) after two Copilot rounds (round 1 four notes applied: raw-text CSS pins, SiteContentEditorTests, the plan note; round 2 clean); 924 tests, 47 fixtures; release and deploy wait for 12a (release PR #108 open, now a minor)
  - Release 1.29.0 (the quick fix and Unit 11): release PR #108 merged by the owner 2026-09-14 (a6ff7b9); release-please published v1.29.0 and the image; DEPLOYED 2026-09-15 by the session on the owner instruction "deploy" (compose tag 1.29.0, pull and recreate, container healthy, live checks passed; the first attempt had been refused by the auto-mode classifier as a production deploy); owner checks open: the Daily visitors tile on /admin/stats and the Current belt select on /admin/site
  - Unit 12 design bundle drafted 2026-09-13 ahead of its stop: inception/application-design/unit12-security-components.md; construction/unit12-security/nfr-requirements/ (nfr-requirements.md, tech-stack-decisions.md); construction/unit12-security/nfr-design/ (nfr-design-patterns.md, logical-components.md); construction/plans/unit12-security-plan.md (two phases); presented after Unit 11 merges
  - [ ] Unit 12: security headers and rate limiting (feat, M; PRs 12a headers, 12b rate limiting) — grilling amendments 2026-09-13 (requirements sections 10.4 and 10.5: hash not nonce, theme editor colors through the CSSOM, ImportMap removed, proxy left alone, report-only first in production, the thresholds, the /signin-* path-scoped limiter, TRUSTED_PROXIES 172.22.0.0/16 and WEB_BIND 127.0.0.1); design bundle (application design, NFR requirements, tech-stack decisions, NFR design, plan construction/plans/unit12-security-plan.md) approved 2026-09-15 (B, one stop); phase 12a COMPLETE 2026-09-15: implemented by a Sonnet phase agent from construction/plans/unit12a-brief.md (six commits; found and suppressed the framework's own X-Frame-Options SAMEORIGIN and frame-ancestors self defaults, which explained the headers seen in production), five-area review (findings applied by a remediation agent: cached headers, the fuller Permissions-Policy, two extra headers, the announced saved notice, the reset reload, pinned suppressions, a shared LinkedSource reader), merged as PR #110 (1153ece) after two Copilot rounds (round 1: an atomic cache object, a last-known snapshot, one snapshot per response; round 2 clean); 990 tests, 54 fixtures; release 1.30.0 (PR #111 merged by the owner 2026-09-15); DEPLOYED 2026-09-15 with SECURITY_CSP_MODE=report-only on the owner instruction "work it" (live headers verified; the old SAMEORIGIN and frame-ancestors self gone from the live response); OWNER CHECK OPEN: the admin pages with the browser console per construction/build-and-test/security-verification-instructions.md, then the session flips to enforce; phase 12b IN PROGRESS 2026-09-15 (brief construction/plans/unit12b-brief.md); CodeQL issue #88 DONE 2026-09-15 in parallel (alert 1 dismissed as a false positive with the rationale; alert 2 fixed by LogSafe.Sanitize at three log sites, merged as PR #112 after the five-area review and two Copilot rounds, 1001 tests, 55 fixtures; the issue commented and closed through the PR)
...
- [x] Release v1.28.0 deployed 2026-09-12 by the session (owner instruction): Units 13 and 14, the shared atomic-write refactor and the 1.27.0 tooltip wording; production compose at 1.28.0; portfolio-web healthy; the résumé mount read-write
