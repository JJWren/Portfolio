...
- [ ] Post-Unit 10 follow-ups (started 2026-09-04): owner approved A (deploy checklist), B (theme-toggle titles), C (current belt), D (security headers and rate limiting); E nothing, the other follow-ups stay deferred. Requirements: inception/requirements/requirements-post-unit10-followups.md (B minimal, C standard, D standard). Owner checklist for A: construction/unit10-bjj-landing/owner-deploy-checklist.md (delivered 2026-09-04; the owner completed it the same day: SITE_FLAVOR=bjj live in production).
  ...
  - [ ] Quick fix (owner decision 2026-09-13, Q3): average per day on the Daily visitors tile (fix, XS, PR 1.5 ahead of Unit 11) — requirements FR-S1 to FR-S3; plan construction/plans/quick-stats-tile-plan.md; awaiting the Unit 11 stop
  - [ ] Unit 11: current belt for the rank bar (feat, S, migration AddCurrentBelt) — functional design construction/unit11-current-belt/functional-design/ (BR-20 to BR-25) and plan construction/plans/unit11-current-belt-plan.md written 2026-09-13; awaiting the one stop (design, plan and the quick-fix plan together)
