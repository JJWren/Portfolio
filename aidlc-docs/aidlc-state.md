...
- [ ] Post-Unit 10 follow-ups (started 2026-09-04): owner approved A (deploy checklist), B (theme-toggle titles), C (current belt), D (security headers and rate limiting); E nothing, the other follow-ups stay deferred. Requirements: inception/requirements/requirements-post-unit10-followups.md (B minimal, C standard, D standard). Owner checklist for A: construction/unit10-bjj-landing/owner-deploy-checklist.md (delivered 2026-09-04; the owner completed it the same day: SITE_FLAVOR=bjj live in production).
  ...
  - [ ] Unit 12: security headers and rate limiting (feat, M; PRs 12a headers, 12b rate limiting) — grilling amendments 2026-09-13 (requirements sections 10.4 and 10.5: hash not nonce, theme editor colors through the CSSOM, ImportMap removed, proxy left alone, report-only first in production, the thresholds, the /signin-* path-scoped limiter, TRUSTED_PROXIES 172.22.0.0/16 and WEB_BIND 127.0.0.1); design bundle (application design, NFR requirements, tech-stack decisions, NFR design, plan construction/plans/unit12-security-plan.md) approved 2026-09-15 (B, one stop); IN PROGRESS 2026-09-15: phase 12a on feat/security-headers (docs commits 53dfee9 and 7b78ea9, brief construction/plans/unit12a-brief.md, Sonnet phase agent), then the five-area review, PR 3, the Copilot gate, the merge, a stop before the release and the report-only deploy; phase 12b follows
