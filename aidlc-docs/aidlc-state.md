...
- [x] Unit 1: Scaffold solution + Docker skeleton (COMPLETE — awaiting checkpoint approval)
...
- [x] Unit 3: Identity + OAuth (COMPLETE — see construction/plans/unit3-identity-oauth-plan.md; live OAuth round-trip pending real client creds)
