    ...
    : IdentityDbContext<ApplicationUser>(options)
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        builder.Entity<SiteContent>(content =>
        {
            ...
            // GamePlan/Principles/Eras/Now are text[] like Skills: per-line
            // length is enforced in SiteContentRules/BjjRules at the app
            // layer, not by a column max length (arrays don't get one,
            // matching Skills).
